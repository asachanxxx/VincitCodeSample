...
namespace Cushwake.TreasuryTool.Infrastructure.Migrations
{
    ...
    [Migration("20220726104906_changedPhysicalAccountOpenRequest")]
    partial class changedPhysicalAccountOpenRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountOpenRequest.SupportDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountOpenRequest.PhysicalAccountOpenRequest", b =>
                {
                    ...
                    b.Property<string>("BibSet")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("BibSetupdatedOn")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("DateSetupOnTramps")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("Reconciliations")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("StatementsAndReconciliations")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountOpenRequest.PhysicalAccountOpenRequest", b =>
                {
                    b.HasOne("Cushwake.TreasuryTool.Domain.Picklist.AccountType", "AccountType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_AccountOpenRequest_AccountTypeID_Type");
                    ...
                    b.HasOne("Cushwake.TreasuryTool.Domain.Picklist.DatabaseType", "DatabaseType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_AccountOpenRequest_DatabaseTypeID_Type");
