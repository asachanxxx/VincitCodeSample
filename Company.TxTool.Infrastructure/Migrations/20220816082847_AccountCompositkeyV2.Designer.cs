...
namespace Cushwake.TreasuryTool.Infrastructure.Migrations
{
    ...
    [Migration("20220816082847_AccountCompositkeyV2")]
    partial class AccountCompositkeyV2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountOpenRequest.BaseAccountOpenRequest", b =>
                {
                    ...
                    b.HasIndex(new[] { "Guid" }, "UIX_AccountOpenRequest_Guid")
                        .IsUnique();
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("AccountRegisterID");
                    ...
                    b.Property<int>("ReconciliationScheduleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReconciliationScheduleId")
                        .IsUnique();
                    ...
                    b.HasIndex(new[] { "Status" }, "IX_AccountRegister_Status");

                    b.HasIndex(new[] { "Type" }, "IX_AccountRegister_Type");

                    b.HasIndex(new[] { "Guid" }, "UIX_AccountRegister_Guid")
                        .IsUnique();

                    b.ToTable("AccountRegister", "app");

                    b.HasDiscriminator<int>("Type");
                });

            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegisterBDocumentation", b =>
                {
                    b.Property<int>("AccountRegisterId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AccountRegisterId", "DocumentId");

                    b.HasIndex("DocumentId");

                    b.HasIndex("TenantID");

                    b.ToTable("AccountRegister_b_Document", "app");
                });
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.Common.SupportDocument", b =>
                {
                    ...
                    b.HasIndex(new[] { "Guid" }, "UIX_SupportDocument_Guid")
                        .IsUnique();
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.Reconciliation.Reconciliation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OriginFrequency")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("Reconciliation", "app");
                });

            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.Reconciliation.ReconciliationSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("DeadlineAfterEvent")
                    ...
                    b.Property<DateTime>("NextReconciliationToBeCreatedOn")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<long>("TriggerGapBeforeEvent")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ReconciliationSchedule", "app");
                });
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.Security.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "ApplicationRoleID" }, "UIX_User_ApplicationRoleID")
                        .IsUnique();

                    b.HasIndex(new[] { "UserGraphId" }, "UIX_User_UserGraphID")
                        .IsUnique();

                    b.HasIndex(new[] { "WorkEmail" }, "UIX_User_WorkEmail")
                        .IsUnique();
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountRegister.PhysicalAccountRegister", b =>
                {
                    b.HasBaseType("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountRegister.VirtualAccountRegister", b =>
                {
                    b.HasBaseType("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister", b =>
                {
                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedByID")
                        .HasConstraintName("FK_AccountRegister_CreatedByID");
                    ...
                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedByID")
                        .HasConstraintName("FK_AccountRegister_ModifiedByID");

                    b.HasOne("Cushwake.TreasuryTool.Domain.Reconciliation.ReconciliationSchedule", "ReconciliationSchedule")
                        .WithOne("AccountRegister")
                        .HasForeignKey("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister", "ReconciliationScheduleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.Navigation("ReconciliationSchedule");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegisterBDocumentation", b =>
                {
                    b.HasOne("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister", null)
                        .WithMany("Documents")
                        .HasForeignKey("AccountRegisterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Cushwake.TreasuryTool.Domain.Common.SupportDocument", "Document")
                        .WithMany()
                    ...
                    b.HasOne("Cushwake.TreasuryTool.Domain.Common.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_AccountRegisterBDocumentation_TenantID");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.Reconciliation.Reconciliation", b =>
                {
                    b.HasOne("Cushwake.TreasuryTool.Domain.AccountRegister.AccountRegister", "AccountRegister")
                        .WithMany()
                        .HasForeignKey("AccountRegisterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedByID")
                        .HasConstraintName("FK_Reconciliation_CreatedByID");

                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedByID")
                        .HasConstraintName("FK_Reconciliation_ModifiedByID");

                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", "PreparedBy")
                        .WithMany()
                        .HasForeignKey("PreparedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", "ReviewedBy")
                        .WithMany()
                    ...
                    b.HasOne("Cushwake.TreasuryTool.Domain.Common.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Reconciliation_TenantID");

                    b.Navigation("AccountRegister");
            ...
            modelBuilder.Entity("Cushwake.TreasuryTool.Domain.Reconciliation.ReconciliationSchedule", b =>
                {
                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedByID")
                        .HasConstraintName("FK_ReconciliationSchedule_CreatedByID");

                    b.HasOne("Cushwake.TreasuryTool.Domain.Security.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedByID")
                        .HasConstraintName("FK_ReconciliationSchedule_ModifiedByID");
                    ...
                    b.HasOne("Cushwake.TreasuryTool.Domain.Common.Tenant", "Tenant")
                        .WithMany()
                        .HasForeignKey("TenantID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
