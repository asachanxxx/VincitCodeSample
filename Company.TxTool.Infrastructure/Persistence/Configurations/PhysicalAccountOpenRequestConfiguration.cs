...
{
    public class PhysicalAccountOpenRequestConfiguration : IEntityTypeConfiguration<PhysicalAccountOpenRequest>
    {
        public void Configure(EntityTypeBuilder<PhysicalAccountOpenRequest> entity)
        {
